"""Dispatch & Resource Assignment — busca recursos, asigna y libera."""
import logging
import uuid
...
from .routes import dispatches, health, resources
...
app = FastAPI(
    title="Emergency Platform — Dispatch & Resource Assignment",
    version="1.0.0",
    docs_url="/docs",
    lifespan=lifespan,
)
...
def _describe(exc: RequestValidationError) -> str:
    ...
    return f"Invalid dispatch payload: {location or 'body'}: {message}"
